...
async function run() {
  ...
  try {
    ...
    // Click on "Quản trị viên Admin" item in sidebar (around x=200, y=260)
    console.log('Clicking on Quản trị viên Admin at (200, 260)...');
    ...
    fs.writeFileSync('scripts/admin_chat_verified.png', Buffer.from(shot.data, 'base64'));
    console.log('Saved scripts/admin_chat_verified.png');
