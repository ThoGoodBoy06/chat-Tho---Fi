...
jsFiles.forEach(filePath => {
  ...
  console.log(`\n📦 Bắt đầu patch theme definitive vào: ${filePath}`);
  let js = fs.readFileSync(filePath, 'utf8');

  // 1. Thêm constructor A.atThemePicker và A.atThemeSocketHandler
...
`;
  ...
  // 3. Khởi tạo B.atThemeRow ngay sau B.anE
...
B.atThemeRow=new A.fd(B.a7,B.bw,B.p,B.l,null,B.az,null,A.b(s([B.atThemeIcon,B.aT,B.atThemeText]),t.p),null)`;
    ...
    if (js.includes(bAnEMarker)) {
      ...
      console.log('✅ Đã khởi tạo B.atThemeRow an toàn ngay sau B.anE');
    }
  }

  // 4. Khởi tạo hàm lấy Gradient theo Theme $.getThemeGradient()
...
`;
  ...
  // 5. Áp dụng Theme Gradient vào bong bóng tin nhắn
  ...
  // 6. Cập nhật Qr để đồng bộ theme khi mở phòng chat & lắng nghe socket
...
if(!$._themeSocketRegistered&&$.bj){
  ...
  // 7. Chèn nút "Chủ đề đoạn chat" vào Dialog Info (A.awd.prototype.$1)
  ...
  console.log(`🎉 Đã lưu bản vá thành công cho ${filePath}`);
});

// 8. Đồng bộ script BottomSheet vào index.html
const htmlFiles = [
...
console.log('\n🌟 ĐÃ HOÀN TẤT BẢN VÁ DEFINITIVE CHO THEME!');
