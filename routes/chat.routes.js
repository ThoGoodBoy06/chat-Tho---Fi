...
router.post("/messages/:messageId/delivered", chatController.markAsDelivered);
...
router.patch("/conversations/:conversationId/members/:userId/nickname", chatController.updateNickname);
router.post("/conversations/:conversationId/members/:userId/nickname", chatController.updateNickname);
